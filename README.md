...
- Выбрать файл прошивки выполнив пункт [Выбор прошивки](#выбор-прошивки).
- Перейти в режим загрузчика нажав "ToBoot" в разделе [Кнопки управления](#кнопки-управления), флаг "BootIsEnable" в разделе [App flash info](#app-flash-info) должен стать "true".
- Разюлокировать память нажав на "FlashUnlocked" в разделе [Status](#status).
- Произвести очистку памяти нажав "Erase" в разделе [Кнопки управления](#кнопки-управления).
- Начать загрузку нажав "Load" в разделе [Кнопки управления](#кнопки-управления).
- Дождаться окончания загрзки. После этого нажать "Reset" или "ToMain" в разделе [Кнопки управления](#кнопки-управления), для перехода в основное приложения.
